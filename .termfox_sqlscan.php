...
function asciiart() {
echo "
    /01010  /0101010   /010  /0101010   /010101     /0101     /0101   /01
   /01     /01   /01  /01   /01        /01        /01  /01   /01 01  /01
  /01001  /01   /01  /01   /0101010   /10       /010  /010  /01  10 /01
    /10  /10 |0/10  /10        /01   /01       /01010101   /10   01/10 -=> Wizard Vector
   /01  /10  |001  /01   /1010010   /01       /010  /101  /01    010 
/1010   |01101001 /01010101        /0101010  /010  /010  /01     01
             101\
\n";
}
asciiart();
...
uzuz:
echo "\n";
userinput("Input Website Yg akan Di scan tanpa mengetik http");
$ip = trim(fgets(STDIN, 1024));
if (strpos($ip, '://') !== false) {
    echo $bold . $red . "\n[!] Salah Goblok :v , input URL tanpa HTTP / HTTPS [!]\n" . $CURLOPT_RETURNTRANSFER;
    goto uzuz;
    ...
    goto uzuz;
	  ...
	  system("$bersih");
	  asciiart();
	  echo "$green {1} SQL Error Page ( Cari Pages Vuln Sql )\n";
	  echo "$green {2} Admin Finder ( Cari Pages Login Admin )\n";
	  echo "$green {3} Robots.txt ( Caritau Isi Robots.txt )\n";
	  echo "$green {4} Bing Dorker ( Dorking Anything )\n";
	  echo "$green {5} Download Hidden Webshell ( output=ini.php )\n";
	  echo "$green {6} Back ( Change Target )\n";
	  echo "$red {0}  Quit!\n";
